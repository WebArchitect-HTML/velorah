        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
          <div className="lg:col-span-5 reveal">
            ...
            <div className="mt-12 space-y-3 text-sm">
              ...
              <p className="-mt-2 mb-2 text-muted-foreground">+33 7 56 82 43 92</p>
            ...
            >
              ...
              <div className="flex items-start gap-3">
                <input
                  ...
                  required
                  className="mt-1 h-4 w-4 rounded border-foreground/25 text-foreground focus:ring-foreground"
                />
                <label htmlFor="consent" className="text-xs text-muted-foreground leading-relaxed">
                  J'accepte la collecte de mon e-mail pour me faire répondre. <a href="/mentions-legales" className="text-foreground underline">En savoir plus</a>
                </label>
              </div>
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 pt-2">
                ...
                <button
                  type="submit"
                  disabled={status === 'submitting' || status === 'success' || !consent}
              ...
              {status === 'error' && (
                <p role="alert" className="pt-2 text-sm font-medium text-destructive">
                  Une erreur s'est produite lors de l'envoi. Réessayez ou écrivez-nous directement à contact@kusooo.fr.
                </p>
              )}
            </form>
          </div>
