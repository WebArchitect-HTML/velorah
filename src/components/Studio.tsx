...
const PROJECTS = [
  ...
  },
  {
    ...
    description: 'Une landing page technologique immersive pour une plateforme d’intelligence modulaire.',
  ...
  },
  {
    ...
    description: 'Un hero scroll-driven aux typographies superposées et à l’énergie rétro-futuriste.',
    href: '/projects/kusooo/',
  },
];
